# O nome dos arquivos de testes são nomeadas 'test_' e além disso o
# nomes de testes devem ser o mais verbosos possível. Na programação, "verboso" (ou verbose) 
# significa explícito e minuciosamente explicado. Então, nosso método se chamará 
...
class TestClass:
    ...
    #Usando o import de markers, podemos classificar tests com tags, definindo nomes diferentes para o decorator:
    @mark.calcular_bonus    
    ...
    def test_quando_calcular_bonus_recebe_100000000_deve_retornar_exception(self):
        with pytest.raises(Exception):
            ...
            # Não precisa colocar o esperado!
